        ...
        <>
            ...
            <div className='flex lg:flex-row flex-col h-[90%] bg-black-1000 lg:justify-center items-center'>
                    <div className='lg:w-1/2 h-[45%] flex flex-col lg:justify-center justify-start items-center' data-aos="fade-down"><img effect='opacity'
                        src="https://abdulahportfolio.blob.core.windows.net/portfolio/MadinahGuider.png"
                        alt="Desktop View"
                    ...
                    />
                        ...
                        <LazyLoadImage effect='opacity'
                            src="https://abdulahportfolio.blob.core.windows.net/portfolio/MadinahGuiderGradient.png"
                            alt="Mobile View"
                    ...
                    <div className='lg:w-1/2 w-5/6 lg:pl-0 lg:pr-0 lg:h-full h-[55%] flex flex-col justify-center items-center' data-aos="fade-up">
                        <div className='flex flex-row gap-3 items-center'>
                            ...
                            <div className='flex flex-col gap-2' style={{ fontFamily: "'Prompt', cursive" }} data-aos="fade-up">
                                <p className='lg:text-4xl text-base font-bold'>MadinahGuider</p>
                                <p className='lg:text-base text-xs'>Your Digital Companion Through Madinah...</p>
                                <p className='flex flex-col text-[rgba(255,255,255,0.30)] lg:text-base text-xs'>Full stack developer<p>Project in 2024</p></p>
                            </div>
                        </div>
                    </div>
                </div>
