...
import karateBHAppGradient from '../assets/KarateBHApp/Landing/karateBHAppGradientPopravni.png';
import GradientTest from '../assets/KarateBHApp/Landing/GradientTest.png';
                    ...
                    <div className='lg:w-1/2 lg:pl-0 lg:pr-0 pr-10 pl-10 lg:h-full flex flex-col justify-center items-center h-full' data-aos="fade-up">
                        <div className='flex flex-row gap-3 items-center'>
                            ...
                            <div className='flex flex-col gap-2' style={{ fontFamily: "'Prompt', cursive" }} data-aos="fade-up">
                                <p className='lg:text-4xl text-base font-bold'>KarateBH App</p>
                                <p className='lg:text-base text-xs'>With sports values, we strengthen society – together</p>
                                <p className='flex flex-col text-[rgba(255,255,255,0.30)] lg:text-base text-xs'>App Developer <p>Project in progress</p></p>
                            </div>
                        </div>
                    </div>
                </div>
