...
import RdOnlineTV1 from '../assets/Rd/Desktop-Mobile/Rd1.png';
import RdOnlineTV2 from '../assets/Rd/Desktop-Mobile/Rd2.png';
import RdOnlineTV3 from '../assets/Rd/Desktop-Mobile/Rd3.png';
import RdOnlineTV7 from '../assets/Rd/Desktop-Mobile/Rd7.png';
import RdOnlineTV8 from '../assets/Rd/Desktop-Mobile/Rd8.png';
import RdOnlineTV9 from '../assets/Rd/Desktop-Mobile/Rd9.png';
import RdOnlineTV10 from '../assets/Rd/Desktop-Mobile/Rd10.png';
        ...
        <>
            <div className='flex flex-col w-full h-screen bg-black-1000'>
                    ...
                    <div className='h-1/6 pl-5 pt-5 w-full' data-aos="fade-down">
                        <div className='flex flex-row gap-3 items-center'>
                            ...
                            <div className='flex flex-col lg:gap-0 gap-2' style={{ fontFamily: "'Prompt', cursive" }} data-aos="fade-down">
                                ...
                                <p className='lg:text-base text-sm'>IPTV with over 17,000 channels</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className='w-full flex justify-between pb-2 cursor-pointer'>
                    ...
                    >
                        Thnx <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-arrow-narrow-right"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M5 12l14 0" /><path d="M15 16l4 -4" /><path d="M15 8l4 4" /></svg>
                    </Link>
                </div>
            </div>
        </>
